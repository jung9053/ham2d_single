...
void computeRHS(GRID *g,SOLN *s,double *l2rho,double*linfrho)
{
  ...
  double radius,p1,rho1,u1,v1,vel12;
  int    n1,n2,n3,n4;
  double xq1,xq2,xq3,xq4,yq1,yq2,yq3,yq4;
  double xmid,ymid,xavg,yavg,dis,pg1,rhog1,ug12,vg1;
...
//==================================================
    ...
    for (j=0;j<chainSize;j++)
    {
      ...
      if (icell >=0 ) 
      //if(icell>=0 || (icell==0&&j==2) || (icell==0&&j==chainSize-3))
      {
        m = NVAR*icell;
      ...
      //if(icell<0 || (icell==0&&j==1) || (icell==0&&j==chainSize-2))
      {
        //
        // do ghost cells
